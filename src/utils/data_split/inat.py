...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', default='data/inat2017_84x84', type=str, help='path to the data')
    parser.add_argument('--split', default='data/split/inat', type=str, help='path to the split folder')
    args = parser.parse_args()
    dataset_list = ['train','val','test']
    #
    prex1 = args.data
    data_path = join(prex1)
#
