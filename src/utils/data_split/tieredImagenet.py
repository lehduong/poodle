...
parser.add_argument('--data', default='data/tiered-imagenet/', type=str, help='path to the data')
parser.add_argument('--split', default='data/split/tiered/', type=str, help='path to the split folder')
