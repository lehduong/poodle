...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', default='data/CUB_200_2011/', type=str, help='path to the data')
    parser.add_argument('--split', default='data/split/cub/', type=str, help='path to the split folder')
...
for dataset in dataset_list:
    ...
    for i, classfile_list in enumerate(classfile_list_all):
        l = int(len(classfile_list)*20/100)
