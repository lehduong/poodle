...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', default='data/EuroSAT', type=str, help='path to the data')
    parser.add_argument('--split', default='data/split/EuroSAT', type=str, help='path to the split folder')
