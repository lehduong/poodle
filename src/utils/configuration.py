...
def parser_args():
    ...
    parser.add_argument('--scheduler-milestones', default=[60, 80], nargs='+', type=int,
    ...
    parser.add_argument('--do-ssl', action='store_true',
                        help='do self-supervised learning (rotation loss)')
    ### others
    ...
    parser.add_argument('--number-fc-update', default=250, type=int,
                        help='Number of gradient update for linear classifier')
    parser.add_argument('--kappa', default=1, type=float,
                        help='Weight between positive and negative samples')
    parser.add_argument('--tsne-viz', action='store_true',
                        help='visualize jsc with t-sne')
